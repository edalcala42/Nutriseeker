          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex  flex-column flex-lg-row align-items-center w-100 justify-content-between">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="{{ route('/') }}"> Medicine </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{ route('/') }}"> Online Buy </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{ route('/') }}"> News </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{ route('create') }}">Regístrate</a>
                </li>
              </ul>
